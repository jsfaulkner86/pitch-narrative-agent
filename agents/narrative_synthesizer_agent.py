...
narrative_synthesizer = Agent(
    ...
    goal="Synthesize all narrative intelligence into a bi-weekly briefing that gives founders specific language improvements, objection responses, and market context updates.",
    backstory="You distill narrative intelligence into founder-ready language. Every recommendation includes a before/after example. Founders leave every briefing with at least 3 things they can change immediately.",
